...
import { profilePictureCache as defaultPfpCache } from "../Store/cache-factory.js";

const MAX_SYNC_ATTEMPTS = 2;

const USER_ID_CACHE = new Map();
const PFP_CACHE = defaultPfpCache;
...
export const makeChatsSocket = (config) => {
   ...
   */ const profilePictureUrl = async (jid, type = "image", timeoutMs) => {
    ...
    const cached = PFP_CACHE.get(cacheKey);
    if (cached) {
      return cached;
    }
